...
const addDecorationElements = (f1, f2, f3) => {
    ...
    // Last Tree
    createImgEl(basePath + '/Other/Tree3.png', 146, f1);
    createImgEl(basePath + '/Other/Tree3.png', 140, f1);
    createImgEl(basePath + '/Bushes/14.png', 137, f1);
    createImgEl(basePath + '/Other/Tree2.png', 135, f1);
    createImgEl(basePath + '/Other/Tree1.png', 130, f1);
    createImgEl(basePath + '/Other/Tree3.png', 125, f1);
    createImgEl(basePath + '/Bushes/14.png', 122, f1);
    createImgEl(basePath + '/Other/Tree2.png', 120, f1);
    //Stone
    createImgEl(basePath + '/Stones/6.png', 10, f1);
    createImgEl(basePath + '/Stones/4.png', 111, f1);
    createImgEl(basePath + '/Stones/4.png', 38, f1);
    createImgEl(basePath + '/Stones/4.png', 55, f3);
    createImgEl(basePath + '/Stones/6.png', 102, f3);
    //Ramp
    createImgEl(basePath + '/Other/Ramp2.png', 22, f2);
    createImgEl(basePath + '/Other/Ramp1.png', 26, f2);
    createImgEl(basePath + '/Other/Ramp2.png', 95, f2);
    createImgEl(basePath + '/Other/Ramp1.png', 99, f2);
    //Bushes
    createImgEl(basePath + '/Bushes/17.png', 19, f2);
    createImgEl(basePath + '/Bushes/17.png', 44, f2);
    createImgEl(basePath + '/Bushes/14.png', 52, f2);
    createImgEl(basePath + '/Bushes/17.png', 69, f2);
    createImgEl(basePath + '/Bushes/17.png', 100, f2);
    createImgEl(basePath + '/Bushes/17.png', 60, f3);
    createImgEl(basePath + '/Bushes/17.png', 13, f3);
    //Fountain
    createImgEl(basePath + 'Fountain/2.png', 116, f1);
    //Box
    createImgEl('Shop2.png', 84, f1);
    createImgEl('Shop3.png', 48, f2);
    createImgEl('Shop11.png', 14, f3);
    createImgEl('Shop11.png', 107, f3);
}
const addEnemies = () => {
...
const addStartScreen = () => {
    ...
    div.innerText = 'Village Market';
    div.style.fontFamily = "'Press Start 2P', cursive";
    div.style.color = '#8babbf';
    ...
    btn.addEventListener('click', () => {
        ...
        let cutscene = new Cutscene([
            'После отъезда из родной деревни, Илья получил сообщение от своих друзей, что на его деревню совершила нападение опасная группировка бандитов.\n\nРодные Ильи перестали выходить на связь. Бросив все свои дела, он решил вернуться в деревню и во всем разобраться.\n\n',
            'Илья возвращается и видит, что на рынок, где он проработал все детство совершено нападение.\n\nВсе торговые лавки захвачены.\n\nИлья смог связаться с друзьями. Они расказали ему, что на краю рынка есть фонтан, под который бандиты установили взрывчатку, которая уничтожит всю деревню.\n\nПросто так обезвредить взрывчатку не получится, для начала нужно найти спрятанный рычаг и ввести код пароля.\n\nПароль состоит из 4 чисел. Цифры пароля находятся внутри тщательно охраняемых лавках(по одной в каждой лавке).\n\n',
            'Что касается рычага - он спрятан на втором уровне, куда у Ильи нет доступа.\n\nДрузья подсказали, что рычаг появится, только когда станут известны все цифры пароля.\n\nКогда появится рычаг у Ильи будет 30 секунд чтобы найти его, подбежать к фонтану и ввести пароль.\n\nЕсли Илья не успеет случится взрыв.\n\n',
        ]);					
    });
    div.appendChild(btn);
}
